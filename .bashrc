...
then
	...
	[ -z $(tty | grep tty) ] && $(source ~/.config/git_prompt.sh && export PS1='\033[32;7m \w\033[27m$(__git_ps1 "\033[45;32m")$(__git_ps1 "\033[0;30;45m%s\033[7m")\033[0m ' || export PS1='\033[32;7m \w\033[27m\033[0m ') || export PS1='\[\033[32m\]\w \[\033[31m\]$ \[\033[38;5;15m\]'
fi
