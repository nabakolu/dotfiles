...
config.bind('ci1', 'config-dict-add --replace url.searchengines invidious https://yewtu.be/search?q={}')
config.bind('ci2', 'config-dict-add --replace url.searchengines invidious https://inv.nadeko.net/search?q={}')
config.bind('ci3', 'config-dict-add --replace url.searchengines invidious https://invidious.nerdvpn.de/search?q={}')
