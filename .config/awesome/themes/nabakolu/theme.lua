...
theme.bg_layoutbox            = xrdb.color0
theme.fg_layoutbox            = xrdb.color7
...
theme.titlebar_minimize_button_normal = gears.surface.load_from_shape(10, 10, gears.shape.circle, xrdb.color8)
theme.titlebar_minimize_button_normal_hover = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color3)
theme.titlebar_minimize_button_normal_press = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color3)
theme.titlebar_minimize_button_focus = gears.surface.load_from_shape(10, 10, gears.shape.circle, xrdb.color3)
theme.titlebar_minimize_button_focus_hover = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color3)
theme.titlebar_minimize_button_focus_press = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color3)
theme.titlebar_ontop_button_normal_active = gears.surface.load_from_shape(10, 10, gears.shape.circle, xrdb.color8)
theme.titlebar_ontop_button_normal_inactive = gears.surface.load_from_shape(10, 10, gears.shape.circle, xrdb.color8)
theme.titlebar_ontop_button_normal_active_hover = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color5)
theme.titlebar_ontop_button_normal_active_press = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color5)
theme.titlebar_ontop_button_focus_active = gears.surface.load_from_shape(10, 10, gears.shape.circle, xrdb.color5)
theme.titlebar_ontop_button_focus_active_hover = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color5)
theme.titlebar_ontop_button_focus_active_press = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color5)
theme.titlebar_ontop_button_normal_inactive_hover = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color6)
theme.titlebar_ontop_button_normal_inactive_press = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color6)
theme.titlebar_ontop_button_focus_inactive = gears.surface.load_from_shape(10, 10, gears.shape.circle, xrdb.color6)
theme.titlebar_ontop_button_focus_inactive_hover = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color6)
theme.titlebar_ontop_button_focus_inactive_press = gears.surface.load_from_shape(20, 10, gears.shape.rounded_bar, xrdb.color6)
