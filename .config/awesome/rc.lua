...
globalkeys = gears.table.join(
    ...
    awful.key({modkey, "Control" }, "Return", function()
        awful.spawn(floating_terminal) end,
    ...
    awful.key({modkey, "Control" }, "BackSpace", function()
        awful.spawn(floating_terminal.." -e lf") end,
    ...
    awful.key({modkey, "Control" }, "p", function()
        awful.spawn(floating_terminal.." -e pulsemixer") end,
    ...
    awful.key({modkey, "Control" }, "m", function()
        awful.spawn(floating_terminal.." -e mocp") end,
    ...
    awful.key({modkey, "Control" }, "n", function()
        awful.spawn(floating_terminal.." -e neomutt") end,
    ...
    awful.key({modkey, "Shift", "Control" }, "n", function()
        awful.spawn(floating_terminal.." -e newsboat") end,
