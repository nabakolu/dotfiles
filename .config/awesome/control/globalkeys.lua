...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey, }, "b",
    function() awful.screen.focused().mywibar.visible = not awful.screen.focused().mywibar.visible end,
  ...
  awful.key({ modkey, }, "f", function() awful.spawn.with_shell("qutebrowser") end,
  ...
  awful.key({ modkey, }, "d",
    function() awful.spawn("j4-dmenu-desktop --case-insensitive --no-generic -t " .. terminal) end,
  ...
  awful.key({}, "XF86AudioRaiseVolume",
    function()
      awful.spawn("pamixer -i 1"); awesome.emit_signal('update-pulse-volume')
    end,
    { description = "raise volume", group = "volume" }),
  awful.key({}, "XF86AudioLowerVolume",
    function()
      awful.spawn("pamixer -d 1"); awesome.emit_signal('update-pulse-volume')
    end,
    { description = "lower volume", group = "volume" }),
  awful.key({}, "XF86AudioMute", function()
      awful.spawn("pamixer -t"); awesome.emit_signal('update-pulse-icon')
    end,
    { description = "toggle mute", group = "volume" }),
  awful.key({}, "XF86AudioMicMute",
    function()
      awful.spawn("pamixer --default-source -t"); awesome.emit_signal('update-pulse-icon')
    end,
